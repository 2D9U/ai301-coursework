...
I have personally used C/C++, C#, Java, Go, JavaScript/TypeScript, Python,
React, Redux, .NET, Spring Boot, gRPC, POSIX, and PyTorch. Most of that time
has gone into backend and systems work: HTTP and gRPC services, their auth
and data layers, and the tests around them.
What I want to get better at is the AI/ML side of a production system.
